...
namespace FlatKit
{
    ...
    public class FogImageEffect : MonoBehaviour
    {
        ...
        [Header("Debug")]
        public Shader fogShader; // Drag the shader here manually if needed
        ...
        void CreateMaterial()
        {
            ...
            if (shader == null)
            {
                Debug.LogError($"Fog shader '{ShaderName}' not found! Please assign the shader manually in the Fog Shader field, or make sure the FogPlus.shader file is in your project.");
                enabled = false;
                return;
            }
